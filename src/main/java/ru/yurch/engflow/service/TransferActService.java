...
public class TransferActService {
    ...
    public List<TransferAct> findByProject(Long projectId){projects.findById(projectId);return acts.findByProjectIdOrderByYearDescNumberDesc(projectId);}
