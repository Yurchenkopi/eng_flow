...
import org.springframework.stereotype.Controller;import org.springframework.ui.Model;import org.springframework.web.bind.annotation.*;import org.springframework.web.servlet.mvc.support.RedirectAttributes;import ru.yurch.engflow.model.ItemSupplier;import ru.yurch.engflow.service.ItemSupplierService;
...
public class ItemSupplierController{
 ...
 @GetMapping("/{id}/edit") public String edit(@PathVariable Long catalogItemId,@PathVariable Long id,Model model){model.addAttribute("itemSupplier",service.find(catalogItemId,id));return "catalog-items/supplier-form";}
 @PostMapping("/{id}") public String update(@PathVariable Long catalogItemId,@PathVariable Long id,@ModelAttribute ItemSupplier itemSupplier,RedirectAttributes redirect){service.update(catalogItemId,id,itemSupplier);redirect.addFlashAttribute("successMessage","Данные поставщика обновлены");return "redirect:/catalog-items/"+catalogItemId+"/edit";}
