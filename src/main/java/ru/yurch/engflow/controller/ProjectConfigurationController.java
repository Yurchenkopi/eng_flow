...
public class ProjectConfigurationController {
    private final ProjectService projectService; private final ProjectItemService itemService; private final ProjectAssemblyService assemblyService;private final TransferActService transferActs;private final ru.yurch.engflow.service.ProcurementService procurements;
    public ProjectConfigurationController(ProjectService projectService, ProjectItemService itemService, ProjectAssemblyService assemblyService,TransferActService transferActs,ru.yurch.engflow.service.ProcurementService procurements) { this.projectService = projectService; this.itemService = itemService; this.assemblyService = assemblyService;this.transferActs=transferActs;this.procurements=procurements; }
