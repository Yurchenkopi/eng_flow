...
EngFlow — внутреннее веб-приложение для инженерной работы. Текущая версия позволяет вести организации и проекты установок, общий каталог покупных изделий, разделы установки и комплектацию проекта.
