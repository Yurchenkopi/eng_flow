...
EngFlow — внутреннее веб-приложение для инженерной работы. Текущая версия позволяет вести организации и их контакты, проекты установок, общий каталог покупных изделий, разделы и комплектацию проекта, а также оформлять акты передачи позиций комплектации в цех.
